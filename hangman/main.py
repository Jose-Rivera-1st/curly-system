...
current_incorrent_guesses = 0

letters_guessed = []

# User gameplay logic.
while current_incorrent_guesses < num_of_incorrect_guesses and False in answer_guessed:
    # Display Game Summary.
    print(f"Number of incorrect guesses remaining: {num_of_incorrect_guesses - current_incorrent_guesses}")
    ...
    if re.search("^[A-Z]$" , letter) and len(letter) == 1 and letter not in letters_guessed:
        ...
        if letter in answer:
            ...
            current_incorrent_guesses += 1

#Post game summary
if current_incorrent_guesses < num_of_incorrect_guesses:
